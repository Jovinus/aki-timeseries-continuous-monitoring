...
class AKIDataModule(pl.LightningDataModule):
    def __init__(
        ...
        if scaling_info is not None:
            ...
            self.train_collate_fn = collate_fn_transformer    
            self.default_collate_fn = collate_fn_transformer
...
class TestDataModule(pl.LightningDataModule):
    def __init__(
        ...
        # Use partial if scaling_info is provided, otherwise use default
        if scaling_info is not None:
            self.default_collate_fn = partial(collate_fn_transformer, scaling_info=scaling_info)
        else:
            self.default_collate_fn = collate_fn_transformer
